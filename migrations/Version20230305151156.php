 ...
 */
final class Version20230305151156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe ADD joueur_id INT DEFAULT NULL, CHANGE rating rating INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe DROP joueur_id, CHANGE rating rating INT DEFAULT NULL');
    }
}
