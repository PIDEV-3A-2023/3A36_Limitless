...
class BlogController extends AbstractController
{
    ...
    public function likeBlog(Blog $blog, EntityManagerInterface $entityManager,$id): Response{
        ...
        $like = $entityManager->getRepository(LikeBlog::class)->findOneBy(['blog' => $blog, 'Joueur' => $user]);
        ...
        $dislike = $entityManager->getRepository(DislikeBlog::class)->findOneBy(['blog' => $blog, 'Joueur' => $user]);
