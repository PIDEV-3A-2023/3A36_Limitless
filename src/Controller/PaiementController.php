...
try{
    ...
    'description'=>'Payement de la commande: '.$refer
           ...
           $errorMessage = $error['message'];
            return $this->render('commande/paiement.html.twig',['erreur'=>$errorMessage]);
       ...
       return $this->render('commande/paiement_success.html.twig',['reference'=>$refer,'nom'=>$nom,'montant'=>$prix]);
    }
